...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, TICI=TICI, DT_DMON=DT_DMON):
    ...
    self._AWARENESS_TIME = 359999. # passive wheeltouch total timeout
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 12.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 6.
    self._DISTRACTED_TIME = 119999. # active monitoring total timeout
    ...
    self._MAX_TERMINAL_ALERTS = 399 # not allowed to engage after 3 terminal alerts
